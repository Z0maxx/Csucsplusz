...
<main class="flex justify-center bg-blue-200">
    <section class="flex flex-col items-center gap-4 py-4 w-9/10 sm:w-auto">
        ...
        <form class="flex flex-col w-full gap-4 p-2 border-2 md:p-4 sm:w-fit border-sky-300 bg-sky-200 rounded-xl">
            <div class="flex flex-col gap-2 px-2 pt-1 pb-2.5 rounded-md has-[input:invalid]:border-amber-500 border-2 border-green-500 bg-slate-200">
                ...
                <input type="text" id="your-name" name="your-name" autocomplete="name" required class="py-0.5 px-1 bg-blue-100 rounded-sm focus:outline-cyan-500 outline-2 outline-blue-300 caret-sky-800">
            </div>
            <div class="flex flex-col gap-2 px-2 pt-1 pb-2.5 rounded-md has-[input:invalid]:border-amber-500 border-2 border-green-500 bg-slate-200">
                ...
                <input type="text" id="birth-name" name="birth-name" required class="py-0.5 px-1 bg-blue-100 rounded-sm focus:outline-cyan-500 outline-2 outline-blue-300 caret-sky-800">
            </div>
            <div class="flex flex-col gap-2 px-2 pt-1 pb-2.5 rounded-md has-[input:invalid]:border-amber-500 border-2 border-green-500 bg-slate-200">
                ...
                <input type="text" id="birth-place" name="birth-place" required class="py-0.5 px-1 bg-blue-100 rounded-sm focus:outline-cyan-500 outline-2 outline-blue-300 caret-sky-800">
            </div>
            <div class="flex flex-col gap-2 px-2 pt-1 pb-2.5 rounded-md has-[input:invalid]:border-amber-500 border-2 border-green-500 bg-slate-200">
            ...
            <div class="flex flex-col gap-2 px-2 pt-1 pb-2.5 rounded-md has-[input:invalid]:border-amber-500 border-2 border-green-500 bg-slate-200">
                ...
                <input type="text" id="citizenship" name="citizenship" value="magyar" required class="py-0.5 px-1 py-0.5 bg-blue-100 rounded-sm focus:outline-cyan-500 outline-2 outline-blue-300 caret-sky-800">
            </div>
            <div class="flex flex-col gap-2 px-2 pt-1 pb-2.5 rounded-md has-[select:invalid]:border-amber-500 border-2 border-green-500 bg-slate-200">
                ...
                <select id="school" name="school" required class="py-0.5 px-1 bg-blue-100 rounded-sm cursor-pointer focus:outline-cyan-500 outline-2 outline-blue-300 caret-sky-800">
            ...
            <div class="flex flex-col gap-2 px-2 pt-1 pb-2.5 rounded-md has-[input:invalid]:border-amber-500 border-2 border-green-500 bg-slate-200">
                ...
                <input type="text" id="id-number" name="id-number" required class="py-0.5 px-1 bg-blue-100 rounded-sm focus:outline-cyan-500 outline-2 outline-blue-300 caret-sky-800">
            </div>
            <div class="flex flex-col gap-2 px-2 pt-1 pb-2.5 rounded-md has-[input:invalid]:border-amber-500 border-2 border-green-500 bg-slate-200">
                ...
                <input type="text" id="home-address" name="home-address" required autocomplete="off" class="py-0.5 px-1 bg-blue-100 rounded-sm focus:outline-cyan-500 outline-2 outline-blue-300 caret-sky-800">
            </div>
            <div class="flex flex-col gap-2 px-2 pt-1 pb-2.5 rounded-md has-[input:invalid]:border-amber-500 border-2 border-green-500 bg-slate-200">
                ...
                <input type="text" id="mail-address" name="mail-address" required autocomplete="off" class="py-0.5 px-1 bg-blue-100 rounded-sm focus:outline-cyan-500 outline-2 outline-blue-300 caret-sky-800">
            </div>
            <div class="flex flex-col gap-2 px-2 pt-1 pb-2.5 rounded-md has-[input:invalid]:border-amber-500 border-2 border-green-500 bg-slate-200">
                ...
                <input type="text" id="phone" name="phone" required autocomplete="phone" class="py-0.5 px-1 bg-blue-100 rounded-sm focus:outline-cyan-500 outline-2 outline-blue-300 caret-sky-800">
            </div>
            <div class="flex flex-col gap-2 px-2 pt-1 pb-2.5 rounded-md has-[input:invalid]:border-amber-500 border-2 border-green-500 bg-slate-200">
                ...
                <input type="text" id="taxnum" name="taxnum" required class="py-0.5 px-1 bg-blue-100 rounded-sm focus:outline-cyan-500 outline-2 outline-blue-300 caret-sky-800">
            </div>
            <div class="flex flex-col gap-2 px-2 pt-1 pb-2.5 rounded-md has-[input:invalid]:border-amber-500 border-2 border-green-500 bg-slate-200">
                ...
                <input type="email" id="email" name="email" required autocomplete="email" class="py-0.5 px-1 bg-blue-100 rounded-sm focus:outline-cyan-500 outline-2 outline-blue-300 caret-sky-800">
            </div>
            ...
            <div class="flex flex-col gap-2 px-2 pt-1 pb-2.5 rounded-md has-[select:invalid]:border-amber-500 border-2 border-green-500 bg-slate-200">
                ...
                <select id="courseType" name="courseType" required class="py-0.5 px-1 bg-blue-100 rounded-sm cursor-pointer focus:outline-cyan-500 outline-2 outline-blue-300 caret-sky-800">
                    <option value="" hidden disabled selected></option>
            ...
            <div class="flex flex-col gap-2 px-2 pt-1 pb-2.5 rounded-md has-[input:invalid]:border-amber-500 border-2 border-green-500 bg-slate-200">
                ...
                <input type="file" id="attachedFile" name="attachedFile" required class="py-0.5 px-1 bg-blue-100 rounded-sm cursor-pointer file:bg-sky-300 file: file:rounded-sm file:my-1 file:px-1 file:py-0.5 focus:outline-cyan-500 outline-2 outline-blue-300 file:font-medium">
            </div>
